...
class Flight internal constructor(private val gameView: GameView, screenX: Int, screenY: Int, res: Resources,densityDpi: Int): GameComponent(res) {
    ...
    init {
        ...
        //health point
        healthPoints = HealthPoints(screenX,res, screenRatioX,densityDpi)
...
//        height *= screenRatioY
        ...
        //define the max minimum size of the width-height Flight Object
        if(width < 70){
            width = 70f
            height = 50f
        }
